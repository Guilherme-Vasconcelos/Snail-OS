...
# FIXME: A limitation currently is that kernel obj files and lib obj files are named by simply renaming
# the file from .c to .o. This essentially means a lib file can only have the same name as a kernel file if
